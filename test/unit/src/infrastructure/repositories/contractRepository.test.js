...
describe('contractRepository', () => {
  ...
  it('should query the database with the correct parameters when calling the findNonTerminatedContractsByProfile method', async () => {
    // GIVEN
    const contractModelDB = {
    ...
    // WHEN
    const result = await repo.findNonTerminatedContractsByProfile(1);
